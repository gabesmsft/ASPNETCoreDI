...
//add this in order to send logs to App Insights via a general logger (without using App Insights SDK logging)
...
namespace ASPNETCoreDI
{
    public class Program
    {
        ...
        public static IWebHostBuilder CreateWebHostBuilder(string[] args) =>
            ...
            //You can actually leave out this .ConfigureAppConfiguration section if you are using appsettings.json,
            ...
            .ConfigureAppConfiguration((hostingContext, config) =>
            {
                ...
                config.AddJsonFile("appsettings1.json", optional: true, reloadOnChange: true)
                      .AddJsonFile($"appsettings1.{env.EnvironmentName}.json",
